...
import { logOutOutline, moonOutline, notificationsOutline, shieldOutline } from 'ionicons/icons';
...
@Component({
  ...
  styles: [`
    ...
    .section-title {
      ...
      letter-spacing: 0.5px; margin: 24px 0 8px 4px;
    }
    .logout-section { padding: 24px 16px; }
    .version {
      text-align: center; font-size: 12px; color: #ccc; padding: 16px;
    }
  `],
})
export class ProfileComponent {
  ...
  constructor() {
    addIcons({ logOutOutline, moonOutline, notificationsOutline, shieldOutline });
  }
